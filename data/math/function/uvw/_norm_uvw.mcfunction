...
execute store result score uvec_x int run compute default float math:uvw/_norm_uvw_x 10000
execute store result score uvec_y int run compute default float math:uvw/_norm_uvw_y 10000
execute store result score uvec_z int run compute default float math:uvw/_norm_uvw_z 10000
