...
execute at @s rotated ~ 0.0 positioned 0.0 0.0 0.0 run tp @s ^ ^ ^1.0
data modify storage math:io xyz set from entity @s Pos
execute store result score iquat_y int store result score iquat_w int run data get storage math:io xyz[2] 10000
execute store result score iquat_x int store result score iquat_z int run data get storage math:io xyz[0] 10000

scoreboard players operation iquat_x int *= sstemp_c int
scoreboard players operation iquat_y int *= sstemp_s int
scoreboard players operation iquat_z int *= sstemp_s int
scoreboard players operation iquat_w int *= sstemp_c int
