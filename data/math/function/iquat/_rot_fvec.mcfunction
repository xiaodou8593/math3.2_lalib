#math:iquat/_rot_fvec
# 旋转fvec
# 输入fvec{<fvec_x,int,1w>,<fvec_y,int,1w>,<fvec_z,int,1w>}
# 输出fvec{<fvec_x,int,1w>,<fvec_y,int,1w>,<fvec_z,int,1w>}

execute store result score sstemp_iy int store result score sstemp_iz int store result score sstempxw int run scoreboard players operation sstemp_ix int = iquat_x int
scoreboard players operation sstemp_ix int *= iquat_x int
execute store result score sstemp_jz int store result score sstempyw int run scoreboard players operation sstemp_jy int = iquat_y int
scoreboard players operation sstemp_jy int *= iquat_y int
execute store result score sstempzw int run scoreboard players operation sstemp_kz int = iquat_z int
scoreboard players operation sstemp_kz int *= iquat_z int
scoreboard players operation sstempx2 int = sstemp_ix int
scoreboard players operation sstempy2 int = sstemp_jy int
scoreboard players operation sstempw2 int = iquat_w int
scoreboard players operation sstempw2 int *= iquat_w int
...
scoreboard players operation sstemp_iy int *= iquat_y int
scoreboard players operation sstemp_jx int = sstemp_iy int
scoreboard players operation sstempzw int *= iquat_w int
...
scoreboard players operation sstemp_iz int *= iquat_z int
scoreboard players operation sstemp_kx int = sstemp_iz int
scoreboard players operation sstempyw int *= iquat_w int
...
scoreboard players operation sstemp_jz int *= iquat_z int
scoreboard players operation sstemp_ky int = sstemp_jz int
scoreboard players operation sstempxw int *= iquat_w int
