...
execute if score temp_state int matches 0 run function math:iquat/test/nvec_to/s0
execute if score temp_state int matches 1 run function math:iquat/test/nvec_to/s1
