...
execute store result score vec_x int run compute default float math:vec/_cross_fvec_x 10000
execute store result score vec_y int run compute default float math:vec/_cross_fvec_y 10000
