...
execute store result score uvec_x int run compute default float math:vec/_norm_ux 10000
execute store result score uvec_y int run compute default float math:vec/_norm_uy 10000
execute store result score uvec_z int run compute default float math:vec/_norm_uz 10000
