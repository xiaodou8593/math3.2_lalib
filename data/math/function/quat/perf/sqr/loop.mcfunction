...
execute store result score sstemp_s int run compute default float math:quat/_sqr

scoreboard players remove perf_loop int 1
execute if score perf_loop int matches 1.. run function math:quat/perf/sqr/loop