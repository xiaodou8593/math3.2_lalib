#math:quat/test/regular/main
# math:quat/test/regular/start异步调用
...
execute if score temp_state int matches 0 run function math:quat/test/regular/s0
execute if score temp_state int matches 1 run function math:quat/test/regular/s1
